export type ProviderName = "copilot" | "openai" | "minimax" | "all";
...
export const PROVIDER_METADATA: Record<ConcreteProviderName, ProviderMetadata> = {
  ...
  minimax: {
    ...
    command: {
      title: "Usage MiniMax",
      value: "plugin.usage.open.minimax",
    },
  },
};

export const PROVIDER_ORDER: readonly ConcreteProviderName[] = ["openai", "copilot", "minimax"];
...
export const USAGE_COMMAND_OPEN_MINIMAX = PROVIDER_METADATA.minimax.command.value;
